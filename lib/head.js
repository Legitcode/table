...
var Head = (function (_React$Component) {
  ...
  _createClass(Head, [{
    ...
    value: function headings() {
      ...
      return Object.keys(this.props.row).map(function (name) {
        return _react2['default'].createElement(
          'th',
          { key: (0, _uniqueId2['default'])(name) },
          _this.props.capitalize ? _this.titleize(name) : name
        );
      });
    }
  }, {
    ...
    value: function titleize(str) {
      var words = str.replace(/([A-Z])/g, ' $1').replace(/_/g, ' ').split(' ');
