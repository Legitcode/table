...
var Table = (function (_React$Component) {
  ...
  _createClass(Table, [{
    ...
    value: function render() {
      ...
      var modify = _props.modify;

      var attributes = _objectWithoutProperties(_props, ['rows', 'capitalize', 'modify']);

      return _react2['default'].createElement(
        'table',
        attributes,
        _react2['default'].createElement(_head2['default'], { row: rows[0], capitalize: capitalize }),
        _react2['default'].createElement(_rows2['default'], { rows: rows, modify: modify || {} })
      );
    }
  }], [{
    key: 'propTypes',
