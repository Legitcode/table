...
var Table = (function (_React$Component) {
  ...
  _createClass(Table, [{
    ...
    value: function render() {
      ...
      var header = undefined;var tableRows = undefined;

      if (rows.length > 0) {
        header = _react2['default'].createElement(_head2['default'], { row: rows[0], capitalize: capitalize });
        tableRows = _react2['default'].createElement(_rows2['default'], { rows: rows });
      }
